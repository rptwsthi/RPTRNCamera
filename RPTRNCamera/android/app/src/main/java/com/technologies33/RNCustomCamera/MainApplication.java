package com.technologies33.RNCustomCamera;
...
//                    .build();
//            packages.add(new MainReactPackage(appConfig));
          return packages;
        }
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.technologies33.RNCustomCamera.ReactNativeFlipper");
        aClass
